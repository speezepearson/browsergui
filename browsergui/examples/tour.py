...
def main():
  ...
  examples[ContinuousSlider] = Example(
    ...
    strip_whitespace('''
      ...
      slider = ContinuousSlider(min=0, max=10, change_callback=slider_changed)
      slider.value = 3'''))
  ...
  GUI(
    ...
    List(items=[
      ...
      Container(
        ...
        example_grid_for_types(Button, ContinuousSlider, IntegerSlider, TextField, Dropdown, NumberField, ColorField, DateField)),
      Container(
