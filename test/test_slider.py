...
from browsergui import ContinuousSlider, IntegerSlider
from . import BrowserGUITestCase

class ContinuousSliderTest(BrowserGUITestCase):
  def test_type_validation(self):
    s = ContinuousSlider(min=0, max=10)
  ...
  def test_range_validation(self):
    s = ContinuousSlider(min=0, max=5)
  ...
  def test_exotic_bounds(self):
    s = ContinuousSlider(min=Fraction(1,10), max=Fraction(9,10))
